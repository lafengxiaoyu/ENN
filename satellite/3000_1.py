...
test_acc = np.sum(pred_outputs == real_outputs)/testsamplesize
...
avg_train_acc = np.mean(winner.fitness)
train_acc = np.mean(winner.fitness)
print("Avg Train Accuracy:{}".format(avg_train_acc))

with open("3000_1.txt","w") as f:
